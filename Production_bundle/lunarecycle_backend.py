...
RATIO_TEST_REVERSE_SEC = float(os.environ.get("LUNA_RATIO_TEST_REVERSE_SEC", "7.0"))
RATIO_TEST_FORWARD_RECOVER_SEC = float(os.environ.get("LUNA_RATIO_TEST_FORWARD_RECOVER_SEC", "7.0"))
...
class ArduinoBridge:
    ...
    def _send_command(self, cmd: str) -> list[str]:
        ...
        elif is_agitator_home:
            total_timeout = AGITATOR_HOME_TIMEOUT
        else:
